...
![Figure 1: Initial output on 7-segment display](assets/output-images/output_image_01.png)

**Description:**
This figure shows the initial output condition of the 7-segment display after running the program on the MDA8086 microprocessor kit.

---

### **Figure 2: 7-Segment Display Output During Sequential Digit Display**

![Figure 2: Sequential digit display on 7-segment display](assets/output-images/output_image_02.png)
...
![Figure 3: Next digit pattern on 7-segment display](assets/output-images/output_image_03.png)
...
![Figure 4: Continued operation of 7-segment display](assets/output-images/output_image_04.png)
...
![Figure 5: Final observed output on 7-segment display](assets/output-images/output_image_05.png)
